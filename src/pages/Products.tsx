            ...
            animationDelay: `${index * 0.2}s`
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-3">
                    {product.id === 1 ? <Link to="/contact" className="flex-1 bg-gradient-to-r from-warm-gold to-soft-pink text-white font-semibold py-3 rounded-full text-center hover:shadow-2xl hover:scale-110 hover:from-warm-gold/90 hover:to-soft-pink/90 transition-all duration-500 transform">
                        Request Quote
                      </Link> : <button disabled className="flex-1 bg-gray-300 text-gray-500 font-semibold py-3 rounded-full text-center cursor-not-allowed opacity-60">
                        Coming Soon
                      </button>}
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="hover:scale-105 transition-transform duration-300">
                      ...
                      <input type="text" name="companyName" value={formData.companyName} onChange={handleInputChange} required className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-warm-gold focus:border-transparent focus:scale-105 transition-all duration-500 hover:border-warm-gold hover:shadow-lg" placeholder="Your Company" />
                    </div>
                    <div className="hover:scale-105 transition-transform duration-300">
                      <label className="block text-sm font-medium text-deep-brown mb-2">
                        Contact Name *
                      </label>
                      <input type="text" name="contactName" value={formData.contactName} onChange={handleInputChange} required className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-warm-gold focus:border-transparent focus:scale-105 transition-all duration-500 hover:border-warm-gold hover:shadow-lg" placeholder="Your Name" />
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="hover:scale-105 transition-transform duration-300">
                      ...
                      <input type="email" name="email" value={formData.email} onChange={handleInputChange} required className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-warm-gold focus:border-transparent focus:scale-105 transition-all duration-500 hover:border-warm-gold hover:shadow-lg" placeholder="your@email.com" />
                    </div>
                    <div className="hover:scale-105 transition-transform duration-300">
                      <label className="block text-sm font-medium text-deep-brown mb-2">
                        Phone Number
                      </label>
                      <input type="tel" name="phone" value={formData.phone} onChange={handleInputChange} className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-warm-gold focus:border-transparent focus:scale-105 transition-all duration-500 hover:border-warm-gold hover:shadow-lg" placeholder="+1 (555) 123-4567" />
                    </div>
                  </div>
                  ...
                  <div className="hover:scale-105 transition-transform duration-300">
                    ...
                    <textarea name="message" value={formData.message} onChange={handleInputChange} rows={5} className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-warm-gold focus:border-transparent focus:scale-105 transition-all duration-500 resize-none hover:border-warm-gold hover:shadow-lg" placeholder="Tell us about your project requirements..." />
                  </div>

                  <button type="submit" className="w-full bg-gradient-to-r from-warm-gold to-soft-pink text-white font-semibold py-4 rounded-xl hover:shadow-2xl hover:scale-110 hover:from-warm-gold/90 hover:to-soft-pink/90 hover:rotate-1 transition-all duration-500 transform">
                    Send Message
                  </button>
                </form>
              </div>
              ...
              <div className="slide-in-right space-y-8">
                <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-700">
                  ...
                  <div className="space-y-6">
                    <button onClick={handleWhatsAppClick} className="w-full flex items-center gap-4 p-4 bg-green-500 hover:bg-green-600 text-white rounded-xl transition-all duration-500 hover:scale-110 hover:shadow-xl hover:rotate-1">
                      <MessageCircle className="w-6 h-6 animate-bounce hover:animate-spin" />
                      <div className="text-left">
                        <div className="font-semibold">WhatsApp Business</div>
                        <div className="text-sm opacity-90">+92 3163385642</div>
                      </div>
                    </button>
