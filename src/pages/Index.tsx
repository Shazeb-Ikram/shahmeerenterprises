  ...
  return (
    <div className={`min-h-screen bg-warm-white transition-opacity duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute bottom-32 right-16 w-32 h-32 bg-warm-gold/20 rounded-full blur-xl float-animation animate-morph" style={{ animationDelay: '2s' }} />
        <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-soft-peach/40 rounded-full blur-lg float-animation animate-morph" style={{ animationDelay: '4s' }} />
        <div className="absolute top-1/3 right-1/4 w-24 h-24 bg-warm-gold/15 rounded-full blur-2xl float-animation animate-morph" style={{ animationDelay: '6s' }} />
        <div className="absolute bottom-1/4 left-1/3 w-12 h-12 bg-soft-pink/25 rounded-full blur-lg float-animation animate-morph" style={{ animationDelay: '8s' }} />
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto slide-in-up">
            ...
            <p className="text-xl md:text-2xl text-deep-brown/80 mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-in hover:text-deep-brown transition-colors duration-300" style={{ animationDelay: '0.5s' }}>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="absolute bottom-20 left-20 w-20 h-20 bg-soft-pink/20 rounded-full blur-xl float-animation animate-morph" style={{ animationDelay: '3s' }} />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16 slide-in-up">
            ...
            <p className="text-xl text-deep-brown/70 max-w-2xl mx-auto animate-fade-in hover:text-deep-brown transition-colors duration-300" style={{ animationDelay: '0.3s' }}>
              ...
              <div className="slide-in-right">
                ...
                <div className="space-y-4 mb-8">
                  {[
                    ...
                    <div key={index} className="flex items-start gap-3 group hover:translate-x-4 transition-all duration-500" style={{ animationDelay: `${index * 0.1}s` }}>
                ...
                <div className="flex flex-col sm:flex-row gap-4 animate-fade-in" style={{ animationDelay: '1s' }}>
                  <Link 
                    to="/products"
                    className="bg-gradient-to-r from-warm-gold to-soft-pink text-white font-semibold px-8 py-4 rounded-full hover:shadow-2xl hover:scale-110 hover:from-warm-gold/90 hover:to-soft-pink/90 hover:rotate-1 transition-all duration-500 text-center btn-magnetic"
                  >
                    View Full Details
                  </Link>
                  <Link 
                    to="/contact"
                    className="border-2 border-warm-gold text-warm-gold font-semibold px-8 py-4 rounded-full hover:bg-warm-gold hover:text-white hover:shadow-xl hover:scale-110 hover:rotate-1 transition-all duration-500 text-center"
                  >
                    Request Sample
                  </Link>
                </div>
      ...
      <footer className="bg-deep-brown text-white py-16 relative overflow-hidden">
        ...
        <div className="absolute bottom-10 left-10 w-16 h-16 bg-soft-pink/10 rounded-full blur-lg float-animation animate-morph" style={{ animationDelay: '4s' }} />
