      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Leadership Section */}
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 mb-12 shadow-lg">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="text-center p-6 bg-gradient-to-br from-warm-gold/10 to-soft-pink/10 rounded-xl">
                  ...
                  <p className="text-deep-brown/90">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 mb-12 shadow-lg">
              ...
              <p className="text-deep-brown text-lg leading-relaxed mb-6">
              ...
              <p className="text-deep-brown text-lg leading-relaxed">
